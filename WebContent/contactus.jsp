...
<div id="menu">
	<ul>
		...
		<li><a href="#" id="menu4" accesskey="3" title="">Login (Customer)</a></li>
		<li><a href="Login.jsp" id="menu5" accesskey="4" title="">Login (Driver)</a></li>
	</ul>
</div>
<br><br><br><br>
<div id="colB">
...
<div id="content">
	<div id="colA">
		<div id="welcome" class="boxedA">
			<h2>Contact us</h2>
			<ul>
					    <h1>Reachout to our team</h1>
						<li> Archit Purohit :6313593163</li>
						<li> Saumitra jain :5088736202</li>   
						<li> Shiren Bhalekar :5182057022</li>
						<li> Sujas Ghiya :5102006826</li>
						<li> Varun Singh :5187677021</li>
						<li> Vishnuprasad ramasubramani:</li>
						<h1> Or Mail Us </h1>
						<li> Email ID :team4softengg@gmail.com</li>										
					</ul>
		</div>
	</div>
