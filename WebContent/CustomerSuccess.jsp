...
<div id="menu">
	<ul>
		...
		<li><a href="<%= response.encodeUrl(request.getContextPath() + "/LoginServlet?action=customerlogin") %>" id="menu3" accesskey="3" title="">Login (Customer)</a></li>
	</ul>
</div>
<br><br><br><br>
<div id="colB">
...
<div id="content">
	<div id="colA">
		<div id="welcome" class="boxedA">
			<font size="2" color="green">Account successfully created with CustomerID: </font><b><%= request.getAttribute("email") %></b><br><br><br>

			<font size="2" color="green">Please Login into your account</font>					    
